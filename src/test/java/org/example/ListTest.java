...
class ListTest {
    ...
    void testAddFirstElement() {
        ...
        //when
        Double arrayListTime = speedTest(() -> arrayList.add(0, 1));
        Double linkedListTime = speedTest(() -> linkedList.add(0, 1));
        //then
        System.out.println("ArrayList add first element time: " + arrayListTime);
        System.out.println("LinkedList add first element time: " + linkedListTime);
    ...
    void testAddLastElement() {
        ...
        LinkedList<Integer> linkedList = new LinkedList<>(bigCollection);
        //when
        Double arrayListTime = speedTest(() -> arrayList.add(arrayList.size(), 1));
        Double linkedListTime = speedTest(() -> linkedList.add(linkedList.size(), 1));
        //then
    ...
    void testRemoveLastElement() {
        ...
        LinkedList<Integer> linkedList = new LinkedList<>(bigCollection);
        //when
        Double arrayListTime = speedTest(() -> arrayList.remove(arrayList.size() - 1));
        Double linkedListTime = speedTest(() -> linkedList.remove(linkedList.size() - 1));
        //then
